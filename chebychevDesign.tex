...
\mathImageFigure{../ece1229-antenna-figures/ChebyChevThreeScaledFig2}{\( T_3( z_0 x) \) for a few different scale factors \( z_0 \).}{fig:ChebyChevThreeScaled:ChebyChevThreeScaledFig2}{0.2}{chebychevPlotsII.nb}
...
\mathImageTwoFigures{../ece1229-antenna-figures/chebLinearFig1}{../ece1229-antenna-figures/chebLogScale40Fig1}{\( T_3 \) fitting of \( N = 4 \) array in linear and \si{dB} scales.}{fig:ChebychevT3Fitting:ChebychevT3FittingFig3}{scale=0.2}{cheb:c.jl}
%\mathImageFigure{../ece1229-antenna-figures/ChebychevT3FittingFig3}{\( T_3 \) fitting of \( N = 4 \) array.}{fig:ChebychevT3Fitting:ChebychevT3FittingFig3}{0.2}{polarPlot.nb}
%\mathImageFigure{../ece1229-antenna-figures/ChebychevT3FittingDbFig4}{\( T_3 \) fitting of \( N = 4 \) array (dB scale).}{fig:ChebychevT3FittingDb:ChebychevT3FittingDbFig4}{0.2}{polarPlot.nb}
