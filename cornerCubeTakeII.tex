...
\makeoproblem{Corner cube antenna.}{advancedantenna:problemSet3TakeII:3}{2015 ps3, p3}{
...
%
\begin{equation}\label{eqn:cornerCubeTakeII:840}
\begin{aligned}
r_m
&= \Abs{ \Br - \Bs_m }
...
%
\begin{equation}\label{eqn:cornerCubeTakeII:60}
\begin{aligned}
...
%
\begin{equation}\label{eqn:cornerCubeTakeII:80}
\begin{aligned}
\BE_m
&= -j \omega \BA_T
...
\end{equation}
%
Writing \( s = \sqrt{2} h \) for the distance from the origin to each of the image sources, the superposition of all the image sources is
%
\begin{equation}\label{eqn:cornerCubeTakeII:480}
\begin{aligned}
\BE
...
%
\begin{equation}\label{eqn:cornerCubeTakeII:500}
\textrm{AF}
= 2 I_0
\lr{
\cos\lr{ k s \sin\theta \cos\lr{ \phi - \pi/4}}
...
%
\begin{equation}\label{eqn:cornerCubeTakeII:560}
\begin{aligned}
D_{0,\textrm{iso}}
...
%
\begin{equation}\label{eqn:cornerCubeTakeII:980}
\begin{aligned}
\textrm{AF}
&= 2 I_0 \lr{
...
so for small \( k s \)
%
\begin{equation}\label{eqn:cornerCubeTakeII:1000}
U = B_0
...
%
\begin{equation}\label{eqn:cornerCubeTakeII:1020}
U_0 = B_0 (k s)^4.
\end{equation}
%
...
%
\begin{equation}\label{eqn:cornerCubeTakeII:601}
\begin{aligned}
P_{\textrm{rad}}
\approx
B_0
...
%
\begin{equation}\label{eqn:cornerCubeTakeII:501}
\textrm{AF}
= 2
\lr{
