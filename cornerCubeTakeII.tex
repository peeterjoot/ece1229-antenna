...
% FIXME: duplicate.
%\imageFigure{../figures/ece1229-antenna-figures/cornerCubeImageSourcePlacementFig3}{Correct image source placement for the corner cube.}{fig:cornerCubeImageSourcePlacement:cornerCubeImageSourcePlacementFig3}{0.2}
...
\mathImageFigure{../figures/ece1229-antenna-figures/arrayFactorXYCorrectedFig4}{Plot of \( \Abs{\textrm{AF}}^2 \) in XY plane with \( \alpha = h/\lambda \).}{fig:arrayFactorXY:arrayFactorXYCorrectedFig4}{0.3}{ps3:ps3Q3plotsCorrected.nb}
...
\mathImageTwoFigures{../figures/ece1229-antenna-figures/ps3p3LinearFig1}{../figures/ece1229-antenna-figures/ps3p3LogScale25Fig1}{Polar plot of \( \textrm{AF} \) in XY plane for various values of \( \alpha = s/\lambda \).}{fig:arrayFactorXY:arrayFactorXYCorrectedFig5}{scale=0.2}{ps3:p3.jl}

%\mathImageFigure{../figures/ece1229-antenna-figures/arrayFactorXYCorrectedFig5}{Polar plot of \( \textrm{AF} \) in XY plane for various values of \( \alpha = s/\lambda \).}{fig:arrayFactorXY:arrayFactorXYCorrectedFig5}{0.3}{ps3:ps3Q3plotsCorrected.nb}
%\mathImageFigure{../figures/ece1229-antenna-figures/ps3p3LogScale25Fig1}{Log polar plot of \( \textrm{AF} \) in XY plane for various values of \( \alpha = s/\lambda \).}{fig:ps3p3LogScale25:ps3p3LogScale25Fig1}{0.3}{ps3:p3.jl}
...
\mathImageFigure{../figures/ece1229-antenna-figures/arrayFactorXYSqCorrectedFig5}{Polar plot of \( \Abs{\textrm{AF}}^2 \) for \( \theta = 0.\)}{fig:arrayFactorXYSqCorrected:arrayFactorXYSqCorrectedFig5}{0.3}{ps3:ps3Q3plotsCorrected.nb}
...
\mathImageFigure{../figures/ece1229-antenna-figures/arrayFactorXYSqIn3DFig6}{Spherical plot of \( \Abs{\textrm{AF}}^2 \) for \( \alpha = 0.69\).}{fig:arrayFactorXYSqIn3D:arrayFactorXYSqIn3DFig6}{0.2}{ps3:ps3Q3plotsCorrected.nb}
