...
%
\makeoproblem{Transmission power determination.}{advancedantenna:problemSet1:5}{2015 ps1, p5}{
\index{transmission power}
...
\index{line of sight}
\index{signal to noise}
\index{polarization mismatch}
\index{transmitted power}
} % makeoproblem
%
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet1Problem5:n}
G = 10^{15/10} \, \si{W}.
\end{equation}
%
The polarization loss factor is
\index{PLF}
\index{polarization loss factor}
%
\begin{equation}\label{eqn:advancedantennaProblemSet1Problem5:40}
\Abs{\rhocap_\txtr \cdot \rhocap_\txtt}^2 \le 10^{-3/10}.
\end{equation}
%
The wavelength is
%
\begin{equation}\label{eqn:advancedantennaProblemSet1Problem5:60}
\begin{aligned}
\lambda &= \frac{3 \times 10^8 \,\si{m/s}}{10^{10} \,\si{s^{-1}}} \\
&= 3 \times 10^{-2} \,\si{m}.
\end{aligned}
\end{equation}
%
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet1Problem5:80}
\begin{aligned}
\frac{P_\txtr}{P_\txtt}
...
\begin{equation}\label{eqn:advancedantennaProblemSet1Problem5:100}
P_\txtt \ge 350 \,\si{W}.
\end{equation}
%}
}
