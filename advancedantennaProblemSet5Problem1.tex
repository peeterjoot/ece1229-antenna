...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:20}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:60}
\begin{aligned}
\BF
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:80}
\begin{aligned}
\int_{-c/2}^{c/2} dz'
e^{j \alpha z' }
&=
...
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:380}
X = k \sin\theta \cos\phi
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:400}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:100}
\begin{aligned}
\BF
...
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:140}
\sin( z + \pi/2 ) + \sin( z - \pi/2 ) = 0
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:160}
...
this reduces to
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:180}
\BF
=
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:200}
\begin{aligned}
\BH
&= -j \omega \BF_T
\\ &=
...
Since
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:280}
\xcap = \sin\theta \cos\phi \rcap + \cos\theta \cos\phi \thetacap - \sin\phi \phicap,
\end{equation}
%
the far field magnetic field is
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:420}
\BH
=
...
\frac{ \sin\lr{ Y b/2 } }{ Y b/2}.
\end{equation}
This can be related to the electric field noting that the dual of the far field relationship
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:220}
\BH_A = \inv{\eta} \rcap \cross \BE_A,
\end{equation}
%
is
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:240}
-\BE_F = \eta \rcap \cross \BH_F,
\end{equation}
%
so the far field electric field is
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:260}
\begin{aligned}
\BE
&= -\eta \rcap \cross \BH
\\ &=
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:300}
\begin{aligned}
\rcap \cross \xcap
&=
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:440}
\BE
=
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:320}
E_\theta =
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem1:340}
E_\phi
=
