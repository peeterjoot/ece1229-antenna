...
%
\makeoproblem{Directivity and free space loss.}{advancedantenna:problemSet1:2}{2015 ps1, p2}{
\index{directivity}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet1Problem2:20}
\begin{aligned}
A_{\tem}
&= \epsilon_{\tem} A_\txtp
\\ &= 0.7 \pi 0.75^2
...
% \nu \lambda = c
\begin{equation}\label{eqn:advancedantennaProblemSet1Problem2:40}
\begin{aligned}
D_0
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet1Problem2:60}
\begin{aligned}
