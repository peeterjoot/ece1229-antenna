...
\newboolean{redacted}
\setboolean{redacted}{true} % version for Prof to distribute.
...
% ****************************************************************************************************
\newcommand{\myTitle}{Advanced Antenna Theory\xspace}
\newcommand{\mySubtitle}{Notes and problems from UofT ECE1229H 2015\xspace}
\newcommand{\myDegree}{}
...
\hypersetup{%
    ...
    pdfsubject={physics modeling},%
    pdfkeywords={Advanced Antenna Theory} {ECE1229H} {University of Toronto},%
    pdfcreator={pdfLaTeX},%
