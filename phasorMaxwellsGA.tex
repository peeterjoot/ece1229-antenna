...
\index{pseudoscalar}
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:320}
\lr{ \Bx \cross \By }
=
-I \lr{ \Bx \wedge \By }
=
...
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:440}
-I \lr{ \Bx \cdot \By }
=
-I \inv{2} \lr{ \Bx \By + \By \Bx }
=
...
\begin{dmath}\label{eqn:phasorMaxwellsGA:360}
\spacegrad \wedge \BE = - j \omega \BB I
\end{dmath}
\begin{dmath}\label{eqn:phasorMaxwellsGA:380}
\spacegrad \cdot \lr{ -\BB I } = \mu_0 \BJ + j \omega \epsilon_0 \mu_0 \BE
\end{dmath}
\begin{dmath}\label{eqn:phasorMaxwellsGA:400}
\spacegrad \cdot \BE = \rho/\epsilon_0
\end{dmath}
\begin{dmath}\label{eqn:phasorMaxwellsGA:420}
...
\cref{eqn:phasorMaxwellsGA:420} shows that the divergence of the dual magnetic field is zero.  It it therefore possible to find a potential \( \BA \) such that
\index{divergence}
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:460}
\BB I = \spacegrad \wedge \BA.
\end{dmath}
%
Substituting this into Maxwell-Faraday \cref{eqn:phasorMaxwellsGA:360} gives
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:480}
\spacegrad \wedge \lr{ \BE + j \omega \BA } = 0.
\end{dmath}
%
This relation is a bivector identity with zero, so will be satisfied if
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:500}
...
Rearranging gives
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:540}
...
\index{Lorentz gauge}
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:580}
0
...
%\begin{dmath}\label{eqn:phasorMaxwellsGA:550}
...
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:740}
...
\index{four current}
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:760}
c \rho - \BJ
=
...
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:780}
\grad \wedge A
=
...
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:800}
...
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:820}
\grad F
=
...
\index{Lorentz gauge}
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:840}
\grad F
=
\grad^2 A
=
...
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:860}
\lr{ \spacegrad^2 + k^2 } \phi = -\rho/\epsilon_0,
\end{dmath}
%
and the spacelike components give
%
\begin{dmath}\label{eqn:phasorMaxwellsGA:880}
