...
Show that,
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem2:20}
...
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem2:60}
\frac{P_2^{\textrm{AUT}}}{P_t} = \lr{\frac{\lambda}{4 \pi R}}^2 G_{\textrm{AUT}} G_\txtt,
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem2:80}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem2:100}
