...
%
\makeoproblem{Corner cube antenna.}{advancedantenna:problemSet3:3}{2015 ps3, p3}{
...
%
%\imageFigure{../figures/ece1229-antenna/cornerCubeGeometryFig2}{Corner cube geometry.}{fig:cornerCubeGeometry:cornerCubeGeometryFig2}{0.3}
\imageFigure{../figures/ece1229-antenna/cornerCubeGeometryFig3}{Corner cube geometry.}{fig:cornerCubeGeometry:cornerCubeGeometryFig3}{0.3}
%
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:60}
\begin{aligned}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:80}
\begin{aligned}
\BE
&= -j \omega \BA_T
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:100}
...
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:140}
\Bp_x = \lr{ -h, \frac{h r \sin\theta \sin\phi}{r \sin\theta\cos\phi + 2 h}, \frac{h r \cos\theta}{r \sin\theta\cos\phi + 2 h}}
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:160}
...
%\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:200}
%\Bp_x \propto \lr{ - \sin\theta\cos\phi - 2 h/r, \sin\theta \sin\phi, \cos\theta}
%\end{equation}
%\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:220}
...
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:260}
\kcap_x = \lr{ - \sin\theta\cos\phi, \sin\theta \sin\phi, \cos\theta}
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:280}
...
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:340}
\begin{aligned}
\BE_x
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:360}
\begin{aligned}
\BE_y
\propto (0,0,1) - \cos\theta \lr{ \sin\theta \cos\phi, -\sin\theta\sin\phi, \cos\theta}
&= \lr{ -\sin\theta \cos\theta \cos\phi, \sin\theta\cos\theta \sin\phi, \sin^2\theta}
...
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:400}
\BE_x
=  j \eta k \frac{ I_0 }{4 \pi r} e^{-j k r} \sin\theta
\lr{ \cos\theta\cos\phi, -\cos\theta \sin\phi, -\sin\theta}
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:420}
\BE_y
=  j \eta k \frac{ I_0 }{4 \pi r} e^{-j k r} \sin\theta
\lr{ \cos\theta \cos\phi, -\cos\theta \sin\phi, -\sin\theta}.
\end{equation}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:440}
\begin{aligned}
k r_x
...
and
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:460}
\begin{aligned}
k r_y
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:480}
\BE
=  j \eta k \frac{ I_0 }{4 \pi r} e^{-j k r} \sin\theta
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:500}
\textrm{AF}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:520}
\begin{aligned}
\Abs{\textrm{AF}}^2
&=
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:560}
\begin{aligned}
D_{0,\textrm{iso}}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:620}
\begin{aligned}
\Abs{\textrm{AF}}^2
\approx
...
With
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:640}
\int_0^{\pi/2} \sin (2\phi) d\phi = 1,
\end{equation}
%
and
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:660}
\int_0^{\pi} \sin^5 \theta d\theta = 16/15,
\end{equation}
%
the radiated power is
%
\begin{equation}\label{eqn:advancedantennaProblemSet3Problem3:680}
...
%
\mathImageFigure{../figures/ece1229-antenna/arrayFactorXYFig4}{Plot of \( \Abs{\textrm{AF}}^2 \) in XY plane with \( \alpha = h/\lambda \).}{fig:arrayFactorXY:arrayFactorXYFig4}{0.3}{ps3:ps3Q3plotsAndMiscIntegrals.nb}
%
This is also plotted in
\cref{fig:arrayFactorXY:arrayFactorXYFig5} for a few selected values of \( h = \alpha \lambda \).
%
\mathImageFigure{../figures/ece1229-antenna/arrayFactorXYFig5}{Polar plot of \( \Abs{\textrm{AF}}^2 \) in XY plane for various values of \( \alpha = h/\lambda \).}{fig:arrayFactorXY:arrayFactorXYFig5}{0.3}{ps3:ps3Q3plotsAndMiscIntegrals.nb}
%
