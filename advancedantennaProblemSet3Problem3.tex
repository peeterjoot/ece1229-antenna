...
%\imageFigure{../ece1229-antenna-figures/cornerCubeGeometryFig2}{Corner cube geometry.}{fig:cornerCubeGeometry:cornerCubeGeometryFig2}{0.3}
\imageFigure{../ece1229-antenna-figures/cornerCubeGeometryFig3}{Corner cube geometry.}{fig:cornerCubeGeometry:cornerCubeGeometryFig3}{0.3}
...
\mathImageFigure{../ece1229-antenna-figures/arrayFactorXYFig4}{Plot of \( \Abs{\textrm{AF}}^2 \) in XY plane with \( \alpha = h/\lambda \).}{fig:arrayFactorXY:arrayFactorXYFig4}{0.3}{ps3:ps3Q3plotsAndMiscIntegrals.nb}

This is also plotted in
\cref{fig:arrayFactorXY:arrayFactorXYFig5} for a few selected values of \( h = \alpha \lambda \).

\mathImageFigure{../ece1229-antenna-figures/arrayFactorXYFig5}{Polar plot of \( \Abs{\textrm{AF}}^2 \) in XY plane for various values of \( \alpha = h/\lambda \).}{fig:arrayFactorXY:arrayFactorXYFig5}{0.3}{ps3:ps3Q3plotsAndMiscIntegrals.nb}
