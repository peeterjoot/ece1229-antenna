...
%
\makeoproblem{Dolph-Chebyshev.}{advancedantenna:problemSet4:4}{2015 ps4, p4}{
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet4Problem4:20}
20 \log_{10} R = 40,
\end{equation}
%
or
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet4Problem4:160}
\begin{aligned}
\textrm{AF}(u)
&= T_4( x )
\\ &= T_4( x_0 \cos(u/2) )
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet4Problem4:100}
\begin{aligned}
\textrm{AF}(u)
&=
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet4Problem4:300}
T_m(x_0 \cos(u/2)) = \cos( m \cos^{-1}\lr{ x_0 \cos(u/2) } ),
\end{equation}
%
equals \( -\pi/2 + n \pi \), or
%
\begin{equation}\label{eqn:advancedantennaProblemSet4Problem4:280}
...
\begin{equation}\label{eqn:advancedantennaProblemSet4Problem4:200}
\Abs{\textrm{AF}(u)}
=
\inv{N}
\frac
