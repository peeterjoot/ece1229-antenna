...
%
\makeoproblem{Patch antenna.}{advancedantenna:problemSet5:2}{2015 ps5, p2}{
\index{patch antenna}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:20}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:40}
\begin{aligned}
W
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:60}
\begin{aligned}
\epsilon_{\textrm{eff}} &=
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:80}
\begin{aligned}
L_0
&= \frac{\lambda_0}{2}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:100}
\begin{aligned}
\frac{\Delta L }{h}
...
\end{equation}
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:120}
\begin{aligned}
\Delta L &= 0.5108 h
\\ &= 0.081 \si{cm},
\end{aligned}
\end{equation}
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:260}
\begin{aligned}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:300}
\begin{aligned}
\lambda_0 &= c/f_0 \\ &= 3 \si{cm},
\end{aligned}
\end{equation}
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:140}
\begin{aligned}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:320}
\frac{h}{\lambda_0} = 0.053 < \inv{10},
\end{equation}
%
which is satisfied, so
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:160}
\begin{aligned}
G
...
\end{equation}
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:180}
\begin{aligned}
B
...
\end{equation}
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:200}
\begin{aligned}
Y_\txts &= G + j B
...
\end{equation}
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:210}
\begin{aligned}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:220}
\begin{aligned}
Z_{\textrm{in} 2} &= \lr{ 19 + 71 j } \Omega \\ &= 73 \phase{\ang{75}} \Omega,
\end{aligned}
\end{equation}
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:240}
\begin{aligned}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:280}
\begin{aligned}
Z_{\textrm{in}}
...
%
\mathImageFigure{../figures/ece1229-antenna/imagZinFig6}{\(\Imag Z_{\textrm{in}} \) variation with \( m \).}{fig:imagZin:imagZinFig6}{0.3}{ps5:pII.m}
%
The zero is found at
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:340}
m = 1.22097,
\end{equation}
%
at which point the new impedance is
%
\begin{equation}\label{eqn:advancedantennaProblemSet5Problem2:n}
Z_{\textrm{in}}
= 152.3 \Omega.
\end{equation}
}
