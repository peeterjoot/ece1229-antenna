...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:20}
\BA = \zcap \frac{A_0}{r} e^{-j k r},
\end{equation}
%
where \( A_0 = \mu_0 I_0 l /4 \pi \).  The far field electric field is
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:40}
\begin{aligned}
\BE &= - j \omega \BA_\T
\\ &= -j \omega
\frac{A_0}{r} e^{-j k r}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:80}
\begin{aligned}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:100}
R =
\frac{
...
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:140}
\alpha_{\textrm{ref}} = \arctan 55/5000
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:160}
\alpha_{\textrm{los}} = \arctan 45/5000
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:180}
r_{\textrm{ref}} = \sqrt{55^2 + 5000^2}
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:200}
r_{\textrm{los}} = \sqrt{45^2 + 5000^2}
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:220}
\kcap_{\textrm{ref}} = \ycap \cos \alpha_{\textrm{ref}} + \zcap \sin\alpha_{\textrm{ref}}
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:240}
...
\index{line of sight}
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:280}
\begin{aligned}
\BE 
&=
j \omega A_0
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:300}
\begin{aligned}
...
\index{ground reflection}
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:420}
\BE =
j \omega A_0
\cos\theta_\txtA \lr{ \sin\theta_\txtA \ycap - \cos\theta_\txtA \zcap }
...
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:340}
\begin{aligned}
k h_\txtt h_\txtr /r
&=
...
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:360}
2 \cos 0.28 = 1.92.
\end{equation}
%
The mobile gain is
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem5:400}
\begin{aligned}
P_\txtr
