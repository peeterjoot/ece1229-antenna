...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:20}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:40}
\begin{aligned}
\Bp \cdot \rcap
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:60}
\BE
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:80}
\begin{aligned}
...
so
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:100}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:120}
\begin{aligned}
...
so
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:140}
E_\theta = q l \frac{\sin\theta}{4 \pi \epsilon_0 r^3}.
\end{equation}
%
Finally the \( E_\phi \) component of this electrostatic field is zero since
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:160}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:280}
q(t) = q e^{j \omega t}.
\end{equation}
%
The dipole moment associated with such a charge distribution is
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:300}
\begin{aligned}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:320}
\begin{aligned}
I(t)
&= \frac{dq(t)}{dt}
...
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:340}
I_0 = j \omega q.
\end{equation}
%
...
\index{permittivity}
%
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:180}
\begin{aligned}
\frac{q}{\epsilon_0}
&=
...
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:220}
E_r = -j \eta I_0 l \frac{\cos\theta}{2 \pi k r^3}
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:240}
E_\theta = -j \eta I_0 l \frac{\sin\theta}{4 \pi k r^3}
\end{equation}
\begin{equation}\label{eqn:advancedantennaProblemSet2Problem4:260}
E_\phi = 0.
\end{equation}
\end{subequations}
%
